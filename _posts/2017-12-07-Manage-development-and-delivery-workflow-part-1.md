...
In this series of posts I'll describe such flow and process, from the Jira ticket to the release (and deployment) using a popular stack, including Jira, Git, Maven, and Jenkins.
